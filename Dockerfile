...
ARG HF_TOKEN
RUN python -c "import os; from huggingface_hub import hf_hub_download; hf_hub_download(repo_id='chrisnguyenx/EfficientNet-P3', filename='efficientnet_b4_cbam_fold1.pth', local_dir='.', token='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')"
